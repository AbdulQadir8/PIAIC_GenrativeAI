...
img = Image.open("piaic.png")

# display image using streamlit
# width is used to set the width of image
...
if st.checkbox("Show/Hide"):
    # display the text if the checkbox returns the True value
...
if st.button("About"):
    st.text("Welcome to world of Genrative AI!!!")
